...
const Home = () => {
    return (
        <div className="bg-white w-full md:max-h-screen md:snap-y md:snap-mandatory md:overflow-y-scroll relative z-[1]">
            <Header />
            <main className="bg-white h-auto md:h-screen container md:snap-start p-4 py-12 relative mx-auto">
